...
const Contact = () => {
  return (
    <div id="contact-section" className="w-[100%] pb-12  pt-7  ">
      ...
      <div className="w-[80%] max-[800px]:w-[100%] ml-32 max-[800px]:w-[85%] w-[80%] max-[800px]:ml-auto max-[800px]:mr-auto ">
        <p className="w-[60%] max-[800px]:text-center max-[800px]:w-[100%] text-[1.2rem]">
      ...
      <div className="ml-32 max-[800px]:ml-0 max-[800px]:text-center">
        <a href="mailto:hammada.reda.dev@gmail.com">
          <ReusableButton
            className="bg-black text-white rounded  mt-5  w-[300px] h-[45px] hover:border-[#147efb] hover:bg-white  pt-2 pb-2   hover:text-[#147efb]   font-bold "
