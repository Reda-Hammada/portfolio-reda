...
const About = () => {
  return (
    <div className='w-[100%]   mt-12 mb-32'>
        ...
        <div className='w-[80%] max-[800px]:w-[95%] ml-auto mr-auto  flex justify-center max-[800px]:flex-col'>
          <div className='w-[95%] '>
              <img  className='h-[290px]  rounded '
                  src={reda} 
                  alt='reda about me image'/>
          </div>
          <div className='w-[95%] max-[800px]:mt-2   h-[290px] text-[1.2rem] text-start ml-6 max-[800px]:ml-0 max-[800px]:mt-2 max-[800px]:text-center'>
              <p>
